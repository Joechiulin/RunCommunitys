...
@interface WatchViewController () <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (section)
    {
        case 0:
        {
            ...
            if (isSDKAAAOK)
            {
                cell.textLabel.text = @"操作軟體初始化成功";
            }
            else
            {
                cell.textLabel.text = @"操作軟體初始化";
            }
